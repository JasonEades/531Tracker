...
namespace FiveThreeOneTracker.Migrations
{
    ...
    [Migration("20260907183129_AddGoogleHealthSteps")]
    partial class AddGoogleHealthSteps
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FiveThreeOneTracker.Models.AccessoryHistory", b =>
                {
                    ...
                    b.HasIndex("UserId", "AccessoryId", "RecordedAt");
            ...
            modelBuilder.Entity("FiveThreeOneTracker.Models.AdditionalSession", b =>
                {
                    ...
                    b.HasIndex("WeekId", "OccurredOn");

                    b.ToTable("AdditionalSessions");
                });

            modelBuilder.Entity("FiveThreeOneTracker.Models.AdditionalStrengthExercise", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("AdditionalSessionId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("AdditionalSessionId");

                    b.ToTable("AdditionalStrengthExercises");
                });

            modelBuilder.Entity("FiveThreeOneTracker.Models.AdditionalStrengthSet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("AdditionalStrengthExerciseId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("AdditionalStrengthExerciseId");

                    b.ToTable("AdditionalStrengthSets");
                });
            ...
            modelBuilder.Entity("FiveThreeOneTracker.Models.Bar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FiveThreeOneTracker.Models.CardioEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("DailyStepRecordId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("DailyStepRecordId")
                        .IsUnique();

                    b.ToTable("CardioEntries");
                });
            ...
            modelBuilder.Entity("FiveThreeOneTracker.Models.DailyStepRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("UserId", "Provider", "Metric", "LocalDate")
                        .IsUnique();

                    b.ToTable("DailyStepRecords");
                });

            modelBuilder.Entity("FiveThreeOneTracker.Models.GoogleHealthConnection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FiveThreeOneTracker.Models.PplSession", b =>
                {
                    ...
                    b.HasIndex("PplWeekId");

                    b.HasIndex("PplProgramId", "OccurredOn");
            ...
            modelBuilder.Entity("FiveThreeOneTracker.Models.PplWeek", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("PplProgramId", "WeekNumber")
                        .IsUnique();
            ...
            modelBuilder.Entity("FiveThreeOneTracker.Models.UserProtocol", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FiveThreeOneTracker.Models.WorkoutSet", b =>
                {
                    ...
                    b.Property<string>("AdditionalSetType")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasIndex("WorkoutId", "LiftId", "IsAdditional", "Sequence");
            ...
            modelBuilder.Entity("FiveThreeOneTracker.Models.AdditionalStrengthExercise", b =>
                {
                    b.HasOne("FiveThreeOneTracker.Models.AdditionalSession", "Session")
                        .WithMany("StrengthExercises")
                        .HasForeignKey("AdditionalSessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FiveThreeOneTracker.Models.AdditionalStrengthSet", b =>
                {
                    b.HasOne("FiveThreeOneTracker.Models.AdditionalStrengthExercise", "Exercise")
                        .WithMany("Sets")
                        .HasForeignKey("AdditionalStrengthExerciseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FiveThreeOneTracker.Models.CardioEntry", b =>
                {
                    ...
                    b.HasOne("FiveThreeOneTracker.Models.DailyStepRecord", "DailyStepRecord")
                        .WithOne("CardioEntry")
                        .HasForeignKey("FiveThreeOneTracker.Models.CardioEntry", "DailyStepRecordId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("Accessory");

                    b.Navigation("DailyStepRecord");
            ...
            modelBuilder.Entity("FiveThreeOneTracker.Models.DailyStepRecord", b =>
                {
                    b.HasOne("FiveThreeOneTracker.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("FiveThreeOneTracker.Models.PplSession", b =>
                {
                    ...
                    b.HasOne("FiveThreeOneTracker.Models.PplWeek", "Week")
                        .WithMany("Sessions")
                        .HasForeignKey("PplWeekId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("FiveThreeOneTracker.Models.Workout", b =>
                {
                    b.HasOne("FiveThreeOneTracker.Models.Bar", "Bar")
                        .WithMany()
                        .HasForeignKey("BarId")
                        .OnDelete(DeleteBehavior.SetNull);
